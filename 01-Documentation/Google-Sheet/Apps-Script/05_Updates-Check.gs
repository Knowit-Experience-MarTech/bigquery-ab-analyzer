...
const messageText = {
  newRelease: `
    ...
    https://github.com/Knowit-Experience-MarTech/bigquery-ab-analyzer/releases
...
function checkForUpdates() {
  ...
  const releases = JSON.parse(
    UrlFetchApp.fetch(
      'https://api.github.com/repos/Knowit-Experience-MarTech/bigquery-ab-analyzer/releases'
    ).getContentText());
